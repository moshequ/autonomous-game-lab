...
test('post-deploy artifact sync preserves strict Pages workflow evidence', async () => {
  ...
  expect(packageJson.scripts['autonomous:post-deploy-readiness-sync']).not.toContain('npm run build')
  expect(packageJson.scripts['autonomous:post-deploy-readiness-sync']).not.toContain('autonomous:release-candidate')
  expect(packageJson.scripts['autonomous:post-deploy-readiness-sync']).not.toContain('autonomous:post-deploy-smoke')
