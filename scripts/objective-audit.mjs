...
const generatedEvidenceWorktreePaths = [
  ...
  /^reports\/[^/]+\.md$/,
  /^src\/data\/[^/]+\.ts$/,
  /^public\/(?:analytics-unlock|measurement-status|owner-unlock|owner-unlock-brief|owner-unlock-preflight|owner-runtime-config|product-gate-recovery|store-readiness|sample-next|sample-fastest|monetization)\.(?:html|json)$/,
