...
const writeLocalEnvTemplate = async (targetPack) => {
  ...
  const section = [
    '# Autonomous Game Lab combined owner input pack',
    `# Generated by ${writeLocalEnvTemplateCommand}`,
    ...linesToAdd,
  ].join('\n')
...
const localTemplateWriteResult = writeLocalEnvTemplateMode
  ? await writeLocalEnvTemplate(combinedOwnerInputPreflight ?? ownerInputPack)
  : null
