export const growthPlan = {
  "generatedAt": "2026-05-22T06:42:47.051Z",
  ...
  "gamePages": [
    {
      ...
      "fullDescription": "Harbor Rings is an original generated strategy puzzle shaped by trend signals, bot checks, and gameplay telemetry. Place colored harbor seals, complete scoring rings, and push for a clean twelve-turn score in a compact solo strategy puzzle.",
      "keywords": [
        "daily puzzle",
        "tile placement",
        "solo board game",
      ...
      "optimization": {
        ...
        "ctaLabel": "Start quick strategy run",
        "reason": "No share clicks captured yet; test faster share-oriented CTA."
      },
      "channelFocus": "shareable-result-loop"
    },
    {
    ...
    },
    {
      ...
      "fullDescription": "A generated engine building puzzle that turns trend signals into a compact solo board state.",
      "keywords": [
        "engine building",
        "expedition planning",
        "daily puzzle",
