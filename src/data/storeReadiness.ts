export const storeReadiness = {
  "generatedAt": "2026-06-11T14:27:14.719Z",
  "sourceDataHash": "ad6a6a1c490f",
  ...
  "googlePlayPrepOwnerInputPack": {
    ...
    "commands": {
      ...
      "githubSecretSet": "printf \"%s\" \"$GOOGLE_PLAY_SERVICE_ACCOUNT_JSON\" | gh secret set GOOGLE_PLAY_SERVICE_ACCOUNT_JSON",
  ...
  "storePaybackLadder": {
    ...
    "channels": {
      "googlePlay": {
        ...
        "spendAllowed": false,
        "blockers": [
          "Store package draft is not ready.",
