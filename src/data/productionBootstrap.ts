export const productionBootstrap = {
  "generatedAt": "2026-05-20T01:35:52.122Z",
  ...
  "repository": {
    ...
    "githubRepositorySource": "missing",
  ...
  "stages": [
    ...
    },
    {
      ...
      "evidence": "3/24 repository variable value(s) present in this environment.",
      "requires": [
        "AGL_PUBLIC_ORIGIN",
        "AGL_PUBLIC_ORIGIN",
        "AGL_PUBLIC_ORIGIN",
    ...
    },
    {
      ...
      "costUsd": 0,
      "command": "./ops/github/setup-production.sh",
      "evidence": "3/8 repository secret value(s) present in this environment.",
      "requires": [
  ...
  "requiredVariables": [
    {
      ...
      "valueSource": "production-environment",
      "configured": true,
  ...
  "externalBlockers": [
    ...
    },
    {
      ...
      "blocker": "Set GITHUB_REPOSITORY/GH_REPO, AGL_GITHUB_OWNER, or authenticate gh so the intended owner/repo can be inferred."
    },
    {
      "source": "repository-bootstrap",
