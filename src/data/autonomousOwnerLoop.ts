export const autonomousOwnerLoop = {
  "generatedAt": "2026-05-19T01:42:07.483Z",
  ...
  "systems": [
    ...
    },
    {
      ...
      "evidence": "Initial JS 649.4 KB; gzip 173.2 KB; deferred chunks 1.",
    ...
    },
    {
      ...
      "evidence": "Completion loop completion-loop-ready; prompt armed; target harbor-rings; completion 40%.",
    ...
    },
    {
      ...
      "evidence": "Candidate pwa-b8f7e5d09ed2; status release-candidate-ready; files 38; smoke URLs 7.",
    ...
    },
    {
      ...
      "evidence": "Smoke blocked-missing-origin; origin missing; candidate pwa-b8f7e5d09ed2; checks 0/8 passed.",
    ...
    },
    {
      ...
      "evidence": "History operator-history-ready; records 9; executed 0.",
  ...
  "credentialRequiredActions": [
    ...
    {
      "id": "env-agl-android-sha256-cert-fingerprint",
      "status": "credential-required",
      "target": "AGL_ANDROID_SHA256_CERT_FINGERPRINT",
    ...
    },
    {
      ...
      "status": "credential-required",
      "target": "AGL_ANDROID_KEYSTORE_BASE64",
      "purpose": "Repository secret sourced from AGL_ANDROID_KEYSTORE_BASE64.",
      "source": "production-bootstrap"
    },
    {
      "id": "secret-agl-android-keystore-password",
      "status": "credential-required",
      "target": "AGL_ANDROID_KEYSTORE_PASSWORD",
      "purpose": "Repository secret sourced from AGL_ANDROID_KEYSTORE_PASSWORD.",
      "source": "production-bootstrap"
    },
    {
      "id": "secret-agl-android-key-alias",
      "status": "credential-required",
      "target": "AGL_ANDROID_KEY_ALIAS",
      "purpose": "Repository secret sourced from AGL_ANDROID_KEY_ALIAS.",
      "source": "production-bootstrap"
    },
    {
