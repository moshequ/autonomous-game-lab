export const postDeploySmoke = {
  "generatedAt": "2026-05-21T23:21:11.437Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-bd935ce440be",
    "aggregateHash": "bd935ce440be2f34fddb5bcc4725d93cb0e86fbdcd36493f69ad88b2336a1e37",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-4e3e9f2967ef",
        "localAggregateHash": "4e3e9f2967ef65d8110418692a33be7c950b374b9e5d45ab6e7c4b209ef096b0",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-bd935ce440be",
      "deployedAggregateHash": "bd935ce440be2f34fddb5bcc4725d93cb0e86fbdcd36493f69ad88b2336a1e37"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-bd935ce440be; run the deploy workflow for strict proof of the current local candidate if needed.",
