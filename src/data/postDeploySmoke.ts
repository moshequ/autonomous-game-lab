export const postDeploySmoke = {
  "generatedAt": "2026-05-26T12:57:51.152Z",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-834480f69b0d",
      "deployedAggregateHash": "834480f69b0dcd7224fe67ea120469253651891f0d9ad5dd7bd2fbb12b58ac60",
  ...
  "nextActions": [
    "Live Pages is reachable and serving pwa-834480f69b0d; run the deploy workflow for strict proof of the current local candidate if needed.",
