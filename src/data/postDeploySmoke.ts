export const postDeploySmoke = {
  "generatedAt": "2026-05-22T02:42:20.509Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-c5be6fccd871",
    "aggregateHash": "c5be6fccd871c1bd1f01610811a23d90b7d1dce9e6fbce7bd2f06d387389fcbb",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-758d7f3ba953",
        "localAggregateHash": "758d7f3ba953f632613d3c536256a9dbdf8ea78b1123cfbc155a3a28b5914f67",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-c5be6fccd871",
      "deployedAggregateHash": "c5be6fccd871c1bd1f01610811a23d90b7d1dce9e6fbce7bd2f06d387389fcbb"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-c5be6fccd871; run the deploy workflow for strict proof of the current local candidate if needed.",
