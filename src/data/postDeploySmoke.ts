export const postDeploySmoke = {
  "generatedAt": "2026-05-22T02:10:05.786Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-cd958454bfd1",
    "aggregateHash": "cd958454bfd13da04d9fba264307cedf560485cc86e4b5fe6ee36c1a46479848",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-2b6b6c58723c",
        "localAggregateHash": "2b6b6c58723c9825ba3e2268d0d1155c520d0991daf5bce0db52f2eea886349c",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-cd958454bfd1",
      "deployedAggregateHash": "cd958454bfd13da04d9fba264307cedf560485cc86e4b5fe6ee36c1a46479848"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-cd958454bfd1; run the deploy workflow for strict proof of the current local candidate if needed.",
