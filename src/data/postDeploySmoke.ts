export const postDeploySmoke = {
  "generatedAt": "2026-05-21T06:24:44.799Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-f11adc88d9d5",
    "aggregateHash": "f11adc88d9d5fc69189466f1f8bcbf7a8f0471fe1c51011b938791f7493e6211",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-40ec4ae71f2d",
        "localAggregateHash": "40ec4ae71f2de36ee49a2eda0ffe328f4730b564b58b9709bfc38fa8ff055d55",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-f11adc88d9d5",
      "deployedAggregateHash": "f11adc88d9d5fc69189466f1f8bcbf7a8f0471fe1c51011b938791f7493e6211"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-f11adc88d9d5; run the deploy workflow for strict proof of the current local candidate if needed.",
