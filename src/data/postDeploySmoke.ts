export const postDeploySmoke = {
  "generatedAt": "2026-05-21T18:41:58.880Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-a3128a473d44",
    "aggregateHash": "a3128a473d441344a44979cb6ebf78511258b117cb816938d622838136d0240a",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-271f489dd490",
        "localAggregateHash": "271f489dd49077a1efc54e824a2ffebb78ef30cb226bc1c76b6b4ee0eb5480ae",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-a3128a473d44",
      "deployedAggregateHash": "a3128a473d441344a44979cb6ebf78511258b117cb816938d622838136d0240a"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-a3128a473d44; run the deploy workflow for strict proof of the current local candidate if needed.",
