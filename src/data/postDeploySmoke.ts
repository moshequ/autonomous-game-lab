export const postDeploySmoke = {
  "generatedAt": "2026-05-20T19:15:29.583Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-34e81af9e2db",
    "aggregateHash": "34e81af9e2db1f84c0ec82a030bfe5516a80b8d9471db6b3caf82446774b32f6",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-43328271e46c",
        "localAggregateHash": "43328271e46cf3f31235fa1e2e55b58eeb89512c7578a856db48dcfda56354b9",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-34e81af9e2db",
      "deployedAggregateHash": "34e81af9e2db1f84c0ec82a030bfe5516a80b8d9471db6b3caf82446774b32f6"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-34e81af9e2db; run the deploy workflow for strict proof of the current local candidate if needed.",
