export const postDeploySmoke = {
  "generatedAt": "2026-05-21T15:48:30.551Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-d0418481f47c",
    "aggregateHash": "d0418481f47cd2c6b0cf7173c5998b3fe0d4fee4a9f58fc57a7ce396d6513e0e",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "localAggregateHash": "0c0e83792f578e2b4bcf9424bb0c02692409fc8464924230257c577a053b0100",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-d0418481f47c",
      "deployedAggregateHash": "d0418481f47cd2c6b0cf7173c5998b3fe0d4fee4a9f58fc57a7ce396d6513e0e"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-d0418481f47c; run the deploy workflow for strict proof of the current local candidate if needed.",
