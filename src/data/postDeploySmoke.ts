export const postDeploySmoke = {
  "generatedAt": "2026-05-20T20:43:44.419Z",
  ...
  "liveRelease": {
    ...
    "candidateId": "pwa-e7731f6e5814",
    "aggregateHash": "e7731f6e58147cc13ae823db2ad402b7c2a551c7be6a0678f5431866f21dd9b8",
  ...
  "localArtifactSmoke": {
    ...
    "checks": [
      ...
      },
      {
        ...
        "hashMatches": true,
        "localCandidateId": "pwa-9b784228b215",
        "localAggregateHash": "9b784228b21587e5e7a8fcac507f2dabe1d2d0f6912f3cd0eb4abe0c27a2a885",
  ...
  "checks": [
    ...
    },
    {
      ...
      "deployedCandidateId": "pwa-e7731f6e5814",
      "deployedAggregateHash": "e7731f6e58147cc13ae823db2ad402b7c2a551c7be6a0678f5431866f21dd9b8"
    }
  ],
  "nextActions": [
    "Live Pages is reachable and serving pwa-e7731f6e5814; run the deploy workflow for strict proof of the current local candidate if needed.",
