export const objectiveAudit = {
  "generatedAt": "2026-05-20T16:46:23.405Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26174626490; live matches artifact true; candidate pwa-02250d3377ef",
