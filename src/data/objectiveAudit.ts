export const objectiveAudit = {
  "generatedAt": "2026-05-21T02:55:13.649Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: apply-safe-improvements; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26202486185; live matches artifact true; candidate pwa-17457b53fc46",
  ...
  "completion": {
    ...
    "nextBestAction": "apply-safe-improvements"
  }
} as const
