export const objectiveAudit = {
  "generatedAt": "2026-05-19T07:00:57.844Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Gate recovery: product-gate-recovery-ready; primary firstGameCompletion; needed lift 58",
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Post-deploy smoke: blocked-missing-origin; origin missing; checks 0/8; local artifact predeploy-artifact-smoke-passed 8/8",
