export const objectiveAudit = {
  "generatedAt": "2026-05-21T06:01:40.319Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: run-post-deploy-smoke; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26208190332; live matches artifact true; candidate pwa-7642cab8e7cc",
