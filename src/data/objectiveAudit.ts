export const objectiveAudit = {
  "generatedAt": "2026-05-19T08:31:01.779Z",
  ...
  "requirements": [
    {
      ...
      "evidence": [
        ...
        "Release candidate: release-candidate-ready; 39 files",
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: refresh-product-gate-sample-plan; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Release candidate: release-candidate-ready; smoke URLs 10",
        "Post-deploy smoke: blocked-missing-origin; origin missing; checks 0/11; local artifact predeploy-artifact-smoke-passed 11/11",
  ...
  "completion": {
    ...
    "nextBestAction": "refresh-product-gate-sample-plan"
  }
} as const
