export const objectiveAudit = {
  "generatedAt": "2026-05-20T22:27:34.814Z",
  ...
  "requirements": [
    {
      ...
      "blockers": [
        "Autonomous self-update is self-update-needs-attention; safe pending 64; unsafe pending 5; remote push held."
      ],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: refresh-support-feedback; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26193142076; live matches artifact true; candidate pwa-20309e6830ac",
      ...
      "blockers": [
        "safe-path-allowlist: 64 safe pending file(s), 5 unsafe pending file(s).",
  ...
  "completion": {
    ...
    "nextBestAction": "refresh-support-feedback"
  }
} as const
