export const objectiveAudit = {
  "generatedAt": "2026-05-21T21:30:03.656Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: refresh-replay-loop; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26254154491; live matches artifact true; candidate pwa-a6b6b57fc910",
  ...
  "controls": {
    ...
    "currentWorktreeDirtyFiles": 46,
    "productionBootstrapFresh": true,
    "productionBootstrapSourceDataHash": "09070d9dfdb6",
  ...
  "completion": {
    ...
    "nextBestAction": "refresh-replay-loop"
  }
} as const
