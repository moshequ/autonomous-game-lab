export const objectiveAudit = {
  "generatedAt": "2026-05-20T15:43:55.883Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Autonomous self-update: self-update-needs-attention; workflow .github/workflows/autonomous-self-update.yml; unsafe pending 2",
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26171799929; live matches artifact true; candidate pwa-7f57ad8adae7",
      ...
      "blockers": [
        "safe-path-allowlist: 60 safe pending file(s), 2 unsafe pending file(s).",
