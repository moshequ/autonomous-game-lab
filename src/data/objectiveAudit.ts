export const objectiveAudit = {
  "generatedAt": "2026-05-21T21:37:57.481Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Gate recovery: product-gate-recovery-ready; primary firstGameCompletion; experiment collecting-sample; needed lift 128",
        ...
        "Operator selected: optimize-daily-retention; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator history: operator-history-ready; records 40; executed 3",
        "Bootstrap: production-bootstrap-ready",
        "Unlock runner: unlock-runner-idle; runnable 0; queued 0; unsafe 0",
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26254547805; live matches artifact true; candidate pwa-4f0340f870bc",
    ...
    },
    {
      ...
      "summary": "Store listing, compliance drafts, screenshots, Android TWA handoff, and iOS App Store handoff are prepared while store release stays gated.",
      "evidence": [
        ...
        "iOS release: deferred-until-ios-payback; native project deferred true"
      ],
      "blockers": [
  ...
  "controls": {
    ...
    "currentWorktreeDirtyFiles": 48,
    "productionBootstrapFresh": true,
    "productionBootstrapSourceDataHash": "67dd40e3a724",
  ...
  "completion": {
    ...
    "nextBestAction": "optimize-daily-retention"
  }
} as const
