export const objectiveAudit = {
  "generatedAt": "2026-05-21T11:43:10.415Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: collect-gate-sample-downloads; status operator-executed; execution executed"
      ],
      "blockers": [],
