export const objectiveAudit = {
  "generatedAt": "2026-05-21T08:31:38.151Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator history: operator-history-ready; records 39; executed 13",
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26213848462; live matches artifact true; candidate pwa-6e5c07a0bc4b",
  ...
  "completion": {
    ...
    "nextBestAction": "run-daily-owner-loop"
  }
} as const
