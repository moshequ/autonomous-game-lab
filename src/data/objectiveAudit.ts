export const objectiveAudit = {
  "generatedAt": "2026-05-21T00:52:59.905Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: refresh-product-gate-recovery; status operator-executed; execution executed"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26198732122; live matches artifact true; candidate pwa-fb7aa2638782",
