export const objectiveAudit = {
  "generatedAt": "2026-05-20T16:01:38.930Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26173636848; live matches artifact true; candidate pwa-90283660bcc1",
