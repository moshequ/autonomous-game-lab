export const objectiveAudit = {
  "generatedAt": "2026-05-21T15:48:35.036Z",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator selected: collect-gate-sample-downloads; status operator-plan-ready; execution not-requested"
      ],
      "blockers": [],
    ...
    },
    {
      ...
      "evidence": [
        ...
        "Operator history: operator-history-ready; records 40; executed 11",
        ...
        "Strict deploy artifact sync: post-deploy-artifact-sync-passed; run 26235707606; live matches artifact true; candidate pwa-d0418481f47c",
  ...
  "completion": {
    ...
    "nextBestAction": "collect-gate-sample-downloads"
  }
} as const
