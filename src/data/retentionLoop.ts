export const retentionLoop = {
  "generatedAt": "2026-05-23T02:33:27.363Z",
  "status": "retention-loop-ready",
  "sourceDataHash": "11d604a19940",
  "dailyChallenge": {
    "date": "2026-05-23",
    "gameId": "market-pulse",
    "title": "Market Pulse",
  ...
  "samplePolicy": {
    ...
    "nextAction": "Feature the daily challenge via /?game=market-pulse&utm_source=gate_sample&utm_campaign=gate-sample-20260523-d1Retention and collect 10 prompt exposure(s) plus 1 retained start(s)."
  },
  "controls": {
