export const retentionLoop = {
  "generatedAt": "2026-05-22T20:04:19.622Z",
  "status": "retention-loop-ready",
  "sourceDataHash": "0eb9f71dd050",
  "dailyChallenge": {
    "date": "2026-05-22",
    "gameId": "market-pulse",
    "title": "Market Pulse",
  ...
  "samplePolicy": {
    ...
    "nextAction": "Feature the daily challenge via /?game=market-pulse&utm_source=gate_sample&utm_campaign=gate-sample-20260522-d1Retention and collect 10 prompt exposure(s) plus 1 retained start(s)."
  },
  "controls": {
