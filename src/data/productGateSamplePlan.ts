export const productGateSamplePlan = {
  ...
  "summary": {
    ...
    "defaultRouteCampaignId": "gate-sample-20260525-firstGameCompletion",
    "totalPromptViewsNeeded": 70
  },
  "runtimeEvidencePolicy": {
    "defaultRouting": {
      "campaignId": "gate-sample-20260525-firstGameCompletion"
    }
  },
  "controls": {
    "zeroPaidSpend": true,
  ...
  "missions": [
    {
      ...
      "campaignId": "gate-sample-20260525-firstGameCompletion",
      "playPath": "/?game=harbor-rings&utm_source=gate_sample&utm_campaign=gate-sample-20260525-firstGameCompletion",
      "needed": {
        "promptViews": 30,
        "successes": 128,
    ...
    },
    {
      ...
      "campaignId": "gate-sample-20260525-replayRate",
      "playPath": "/?game=harbor-rings&utm_source=gate_sample&utm_campaign=gate-sample-20260525-replayRate",
      "needed": {
        "promptViews": 30,
        "successes": 10,
        "minimumPromptViewsForDecision": 30
    ...
    },
    {
      ...
      "playPath": "/?game=market-pulse&utm_source=gate_sample&utm_campaign=gate-sample-20260525-d1Retention",
      "needed": {
        "promptViews": 10,
        "successes": 1,
