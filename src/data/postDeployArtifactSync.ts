export const postDeployArtifactSync = {
  "generatedAt": "2026-05-25T12:26:50.164Z",
  ...
  "workflow": {
    ...
    "runId": 26400384904,
    "headSha": "f077a24ef6ccb991906bbc5903964b57da2d52e1",
    "createdAt": "2026-05-25T12:25:15Z",
    "url": "https://github.com/moshequ/autonomous-game-lab/actions/runs/26400384904",
    "source": "latest-successful-run",
    "runListAvailable": true
  },
  "artifact": {
    "status": "post-deploy-smoke-passed",
    "generatedAt": "2026-05-25T12:25:53.976Z",
    "target": {
    ...
    "reportSha256": "ff462b1fe78f443efda32ad3f075e40346dcd08ef025868a888f40f7ad96dcb6"
  },
  "live": {
    "origin": "https://moshequ.github.io/autonomous-game-lab/",
    ...
    "bytes": 32668,
    "textSha256": "c7a989dcb7beed2f00bf96acf50ce32651516a39d6aeb29d10b84134ee4a3bb0",
  ...
  "checks": [
    ...
    },
    {
      ...
      "status": "pass",
      "detail": "Latest successful web-pwa-deploy.yml run is 26400384904."
    },
    {
      "id": "post-deploy-smoke-artifact",
      "status": "pass",
      "detail": "Downloaded post-deploy-smoke artifact from run 26400384904."
    },
    {
