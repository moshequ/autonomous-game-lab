export const postDeployArtifactSync = {
  "generatedAt": "2026-05-25T12:21:50.707Z",
  ...
  "workflow": {
    ...
    "runId": 26400186029,
    "headSha": "afb9272107b18d7c16eef4a889f27334c1df90fa",
    "createdAt": "2026-05-25T12:20:13Z",
    "url": "https://github.com/moshequ/autonomous-game-lab/actions/runs/26400186029",
    "source": "latest-successful-run",
    "runListAvailable": true
  },
  "artifact": {
    "status": "post-deploy-smoke-passed",
    "generatedAt": "2026-05-25T12:20:58.715Z",
    "target": {
    ...
    "reportSha256": "f189b1e110ca2b4fe51fb604d52afd77105cfa48bb22452abb585a287e50a47f"
  },
  "live": {
    "origin": "https://moshequ.github.io/autonomous-game-lab/",
    ...
    "bytes": 32679,
    "textSha256": "d8e96a62a0a215799bd987f178135a5935da173e9e973763452922fca146a194",
  ...
  "checks": [
    ...
    },
    {
      ...
      "status": "pass",
      "detail": "Latest successful web-pwa-deploy.yml run is 26400186029."
    },
    {
      "id": "post-deploy-smoke-artifact",
      "status": "pass",
      "detail": "Downloaded post-deploy-smoke artifact from run 26400186029."
    },
    {
