export const postDeployArtifactSync = {
  "generatedAt": "2026-05-26T09:22:59.268Z",
  ...
  "workflow": {
    ...
    "runId": 26443729973,
    "headSha": "20f24c74193f5ed8f320e2601954e8b7dc65f198",
    "createdAt": "2026-05-26T09:21:03Z",
    "url": "https://github.com/moshequ/autonomous-game-lab/actions/runs/26443729973",
    "source": "latest-successful-run",
    "runListAvailable": true
  },
  "artifact": {
    "status": "post-deploy-smoke-passed",
    "generatedAt": "2026-05-26T09:21:59.804Z",
    "target": {
    ...
    "reportSha256": "6781f11100b8523b365d8a6c03206608ae9a72842252339152d4c275defd3267"
  },
  "live": {
    "origin": "https://moshequ.github.io/autonomous-game-lab/",
    ...
    "bytes": 38956,
    "textSha256": "8cfa13439e38883c2f770e60474e5c4522ab9f5c032c8b8ee37e906ed4c60169",
  ...
  "checks": [
    ...
    },
    {
      ...
      "status": "pass",
      "detail": "Latest successful web-pwa-deploy.yml run is 26443729973."
    },
    {
      "id": "post-deploy-smoke-artifact",
      "status": "pass",
      "detail": "Downloaded post-deploy-smoke artifact from run 26443729973."
    },
    {
      "id": "strict-smoke-artifact",
      "status": "pass",
      "detail": "Artifact status post-deploy-smoke-passed; strict manifest comparison true; checks 33/33."
    },
    {
