export const repositoryBootstrap = {
  "generatedAt": "2026-05-19T05:49:19.909Z",
  ...
  "workspace": {
    ...
    "before": {
      ...
      "generatedEvidenceDirtyFiles": 24,
  ...
  "sourceStatus": {
    ...
    "releaseCandidateId": "pwa-1e6f1b62f5f1",
  ...
  "actions": [
    ...
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "24 repository evidence file(s) changed during this dry run; the outer verified commit will persist them."
    },
    {
