export const repositoryBootstrap = {
  "generatedAt": "2026-05-20T04:36:44.158Z",
  ...
  "workspace": {
    ...
    "before": {
      ...
      "generatedEvidenceDirtyFiles": 23,
  ...
  "sourceStatus": {
    ...
    "releaseCandidateId": "pwa-43e6ed2e5286",
  ...
  "actions": [
    ...
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "23 repository evidence file(s) changed during this dry run; the outer verified commit will persist them."
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "Set GITHUB_REPOSITORY/GH_REPO, set AGL_GITHUB_OWNER, or authenticate gh so the target can be inferred before attaching origin."
    },
    {
      ...
      "requiresExplicitEnv": true,
      "detail": "Set GITHUB_REPOSITORY/GH_REPO, set AGL_GITHUB_OWNER, or authenticate gh so the target can be inferred before creating a GitHub repository."
    },
    {
