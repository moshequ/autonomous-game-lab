export const repositoryBootstrap = {
  "generatedAt": "2026-05-19T05:10:39.971Z",
  ...
  "workspace": {
    ...
    "before": {
      ...
      "generatedEvidenceDirtyFiles": 27,
  ...
  "sourceStatus": {
    ...
    "releaseCandidateId": "pwa-0ed66fc4e238",
  ...
  "actions": [
    ...
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "27 repository evidence file(s) changed during this dry run; the outer verified commit will persist them."
    },
    {
