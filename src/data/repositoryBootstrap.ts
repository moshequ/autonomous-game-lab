export const repositoryBootstrap = {
  "generatedAt": "2026-05-19T11:03:34.524Z",
  ...
  "workspace": {
    ...
    "before": {
      ...
      "generatedEvidenceDirtyFiles": 65,
  ...
  "actions": [
    ...
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "65 repository evidence file(s) changed during this dry run; the outer verified commit will persist them."
    },
    {
