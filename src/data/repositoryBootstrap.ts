export const repositoryBootstrap = {
  "generatedAt": "2026-05-19T11:13:30.721Z",
  ...
  "workspace": {
    ...
    "before": {
      ...
      "generatedEvidenceDirtyFiles": 81,
  ...
  "sourceStatus": {
    ...
    "releaseCandidateId": "pwa-e70be74d5bf9",
  ...
  "actions": [
    ...
    },
    {
      ...
      "mutatesRemoteGitHub": false,
      "requiresExplicitEnv": true,
      "detail": "81 repository evidence file(s) changed during this dry run; the outer verified commit will persist them."
    },
    {
