export const productGateRecovery = {
  "generatedAt": "2026-05-19T06:54:57.463Z",
  ...
  "priorities": [
    {
      ...
      "neededSuccesses": 58,
      "promptViewsNeeded": 30,
      "nextMeasurement": "completion_nudge_viewed, completion_nudge_clicked, finish_line_coach_viewed, finish_line_coach_clicked, first_move_coach_used",
    ...
    },
    {
      ...
      "neededSuccesses": 7,
      "promptViewsNeeded": 30,
      "nextMeasurement": "replay_prompt_viewed, replay_prompt_clicked, replay_prompt_dismissed, replay_clicked",
    ...
    },
    {
      ...
      "neededSuccesses": 1,
      "promptViewsNeeded": 10,
      "nextMeasurement": "daily_return_prompt_viewed, daily_return_prompt_clicked, daily_return_intent_viewed, daily_return_intent_started",
  ...
  "nextActions": [
    ...
    "completion-loop should collect 30 more prompt exposure(s) before automation changes copy or placement again.",
