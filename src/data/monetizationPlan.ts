export const monetizationPlan = {
  "generatedAt": "2026-05-25T07:04:24.750Z",
  ...
  "revenueTestPreflight": {
    "status": "waiting-on-provider-or-product-gates",
    "canArmRevenueTest": false,
    "firstRunnablePlacementId": "rewarded-hint-after-failed-daily",
    "checks": [
      {
        "id": "product-gates",
        "status": "blocked"
    ...
    "requiredEnvironment": {
      "web": [
        ...
        {
          "name": "VITE_ADSENSE_REWARDED_SLOT_ID",
          "configured": false
        }
      ],
      "native": [
