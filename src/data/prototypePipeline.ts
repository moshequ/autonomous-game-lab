export const prototypePipeline = [
  ...
  },
  {
    ...
    "concept": {
      ...
      "gameBrief": {
        ...
        "coreLoop": "connect demand before congestion rises by making one strong roll and write decision per turn.",
        "sessionLengthMinutes": 9,
        "playerPromise": "A complete tactical board-game feeling in 9 minutes, tuned for touch screens.",
        "firstPrototypeTemplate": "daily-sheet",
    ...
    "storeListing": {
      ...
      "subtitle": "compact city logistics roll and write",
    ...
    "autonomyActions": [
      "Generate daily-sheet prototype config",
      "Run rule simulator and screenshot smoke test",
      "Ship web/PWA experiment only",
      "Promote to Android only after retention gates pass"
    ]
  },
  {
    ...
    "storeListing": {
      ...
      "fullDescription": "Orbit Atlas is an original mobile-first board-game-inspired puzzle set in modular camp routes around unknown landmarks. A complete tactical board-game feeling in 5 minutes, tuned for touch screens. Core loop: commit scouts without overextending supplies by making one strong worker placement decision per turn. The first release focuses on solo daily play, clear scoring, replayable seeds, and measured improvements from player behavior.",
      "keywords": [
        "worker placement",
        "expedition planning",
        "mobile puzzle",
