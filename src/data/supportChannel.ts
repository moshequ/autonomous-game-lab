export const supportChannel = {
  ...
  "repository": {
    ...
    "metadata": {
      ...
      "isArchived": null,
      "errors": [
        "gh repo view: error connecting to api.github.com\ncheck your internet connection or https://githubstatus.com"
      ],
      "controls": {
  ...
  "issueTemplates": [
    {
      ...
      "containsAggregateOnlyWarning": true,
  ...
  "privacy": {
    ...
    "exportedEventFilePolicy": "Player event exports are player-initiated; public analytics evidence issues accept aggregate counts only, not raw exports or event rows.",
