export const autonomousOperator = {
  ...
  "mode": "plan-only",
  "ownerDecision": {
    "actionId": "seed-portfolio-traffic",
  ...
  "commandPlan": [
    {
      "segment": "npm run autonomous:growth",
      "script": "autonomous:growth"
    },
    {
      "segment": "npm run autonomous:portfolio",
      "script": "autonomous:portfolio"
    },
    {
      "segment": "npm run autonomous:traffic",
      "script": "autonomous:traffic"
    },
    {
      "segment": "npm run autonomous:acquisition",
      "script": "autonomous:acquisition"
    },
    {
      "segment": "npm run autonomous:organic-seed-loop",
      "script": "autonomous:organic-seed-loop"
    }
  ],
  "execution": {
    "requested": false,
  ...
  "nextActions": [
    "Run npm run autonomous:operator -- --execute --action=seed-portfolio-traffic to execute exactly one allowed local action.",
