export const autonomousOperator = {
  ...
  "blockedActions": [
    ...
    },
    {
      ...
      "reason": "status-blocked-needs-repository-channel"
    },
    {
      ...
      "reason": "status-blocked-needs-collector-or-posthog"
    }
  ],
  "commandPlan": [
    {
      "segment": "npm run autonomous:repo-readiness",
      "script": "autonomous:repo-readiness"
    },
    {
      "segment": "npm run autonomous:repo-bootstrap",
      "script": "autonomous:repo-bootstrap"
    }
  ],
  "execution": {
    "requested": true,
    ...
    "results": [
      {
        ...
        "exitCode": 0,
        "stdoutTail": [
          "> autonomous-game-lab@0.0.0 autonomous:repo-readiness",
          "> node scripts/repository-readiness.mjs",
          "Wrote data/repository-readiness.json",
          "Wrote src/data/repositoryReadiness.ts",
          "Wrote reports/repository-readiness-latest.md"
        ],
        "stderrTail": []
      },
      {
        ...
        "exitCode": 0,
        "stdoutTail": [
          "> autonomous-game-lab@0.0.0 autonomous:repo-bootstrap",
          "> node scripts/repository-bootstrap.mjs",
          "Wrote data/repository-bootstrap.json",
          "Wrote src/data/repositoryBootstrap.ts",
          "Wrote reports/repository-bootstrap-latest.md",
          "Wrote ops/github/bootstrap-repository.sh"
        ],
        "stderrTail": []
      }
    ]
  ...
  "controls": {
    "zeroPaidSpend": true,
    "allOwnerGuardrailsEnforced": true,
  ...
  "nextActions": [
    "Review prepare-repository-channel execution results before another operator run.",
