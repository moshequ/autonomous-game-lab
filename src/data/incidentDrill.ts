export const incidentDrill = {
  "generatedAt": "2026-05-22T09:13:03.895Z",
  "status": "pass",
  ...
  "stdout": [
    "Wrote ../../../../../tmp/agl-incident-drill-gdACvc/data/experiment-policy.json",
    "Wrote ../../../../../tmp/agl-incident-drill-gdACvc/data/production-response.json",
    "Wrote ../../../../../tmp/agl-incident-drill-gdACvc/src/data/productionResponse.ts",
    "Wrote ../../../../../tmp/agl-incident-drill-gdACvc/reports/production-response-latest.md"
  ]
} as const
