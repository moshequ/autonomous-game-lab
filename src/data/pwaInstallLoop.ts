export const pwaInstallLoop = {
  "generatedAt": "2026-05-26T19:35:30.963Z",
  "sourceDataHash": "1f0dec3689d1",
  ...
  "samplePlan": {
    ...
    "installSampleNextAction": "Publish to a stable HTTPS host before treating PWA install evidence as production-ready."
  },
  "installSample": {
    "status": "collecting-sample",
    "campaignId": "pwa-install-market-pulse",
