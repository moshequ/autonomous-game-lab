export const pwaInstallLoop = {
  "generatedAt": "2026-05-26T22:03:31.723Z",
  "sourceDataHash": "dbd030531d76",
  ...
  "samplePlan": {
    ...
    "installSampleNextAction": "Route zero-spend install traffic through /?game=market-pulse&utm_source=pwa_install&utm_campaign=pwa-install-market-pulse until 20 prompt view(s) and 10 launch-mode event(s) are collected."
  },
  "installSample": {
    "status": "collecting-sample",
    "campaignId": "pwa-install-market-pulse",
