export const ownerZeroSecretInputSync = {
  "generatedAt": "2026-05-26T20:06:19.703Z",
  "status": "owner-zero-secret-input-sync-waiting-on-input",
  "mode": "zero-secret-public-owner-inputs",
  "source": {
    "ownerUnlockPreflightStatus": "owner-unlock-preflight-waiting-on-input",
    "workflowInputsEnabled": false
  },
  "inputs": [
    {
