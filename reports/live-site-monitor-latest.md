...
- pass: install-html; /install.html; HTTP 200; 204 ms; Live read-only check passed.
...
- pass: games-foundry-ledger-html; /games/foundry-ledger.html; HTTP 200; 213 ms; Live read-only check passed.
- pass: release-candidate-manifest-live; /release-candidate.json; HTTP 200; 213 ms; Live read-only check passed.
