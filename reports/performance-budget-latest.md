...
Generated: 2026-05-25T19:57:45.529Z
Status: performance-budget-ready
Initial JS: 690.5 KB (186.2 KB gzip)
Initial CSS: 10.5 KB (2.8 KB gzip)
Deferred game chunk: GameCanvas-BILmdnBe.js, 3.3 KB
Largest JS chunk deferred: yes

## Checks

- monitor: initial-js-target - Initial JS is 690.5 KB; target is 686 KB.
- pass: initial-js-budget - Initial JS is 690.5 KB; deploy cap is 700 KB.
- pass: initial-js-gzip-budget - Initial JS gzip is 186.2 KB; budget is 200 KB.
...
- pass: game-runtime-deferred - GameCanvas-BILmdnBe.js is deferred from the initial shell.
