...
Generated: 2026-05-26T20:06:42.863Z
Status: performance-budget-ready
Initial JS: 670.1 KB (178.4 KB gzip)
Initial CSS: 12 KB (3.1 KB gzip)
Deferred game chunk: GameCanvas-CMmCc1q3.js, 3.3 KB
Largest JS chunk deferred: yes

## Checks

- pass: initial-js-target - Initial JS is 670.1 KB; target is 686 KB.
- pass: initial-js-budget - Initial JS is 670.1 KB; deploy cap is 700 KB.
- pass: initial-js-gzip-budget - Initial JS gzip is 178.4 KB; budget is 200 KB.
...
- pass: game-runtime-deferred - GameCanvas-CMmCc1q3.js is deferred from the initial shell.
