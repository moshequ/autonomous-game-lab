...
Generated: 2026-06-08T02:21:34.687Z
Status: performance-budget-ready
Initial JS: 631.7 KB (171.6 KB gzip)
Initial CSS: 12.6 KB (3.2 KB gzip)
Deferred game chunk: GameCanvas-ruf4wg0W.js, 3.3 KB
Largest JS chunk deferred: yes

## Checks

- pass: initial-js-target - Initial JS is 631.7 KB; target is 686 KB.
- pass: initial-js-budget - Initial JS is 631.7 KB; deploy cap is 700 KB.
- pass: initial-js-gzip-budget - Initial JS gzip is 171.6 KB; budget is 200 KB.
- pass: initial-css-budget - Initial CSS is 12.6 KB; budget is 40 KB.
- pass: manifest - PWA manifest exists in dist.
- pass: service-worker - Service worker exists in dist.
- pass: game-runtime-deferred - GameCanvas-ruf4wg0W.js is deferred from the initial shell.
