...
Generated: 2026-05-25T23:30:47.288Z
Status: performance-budget-ready
Initial JS: 692.2 KB (187.2 KB gzip)
Initial CSS: 10.5 KB (2.8 KB gzip)
Deferred game chunk: GameCanvas-CVTjfOJg.js, 3.3 KB
Largest JS chunk deferred: yes

## Checks

- monitor: initial-js-target - Initial JS is 692.2 KB; target is 686 KB.
- pass: initial-js-budget - Initial JS is 692.2 KB; deploy cap is 700 KB.
- pass: initial-js-gzip-budget - Initial JS gzip is 187.2 KB; budget is 200 KB.
...
- pass: game-runtime-deferred - GameCanvas-CVTjfOJg.js is deferred from the initial shell.
