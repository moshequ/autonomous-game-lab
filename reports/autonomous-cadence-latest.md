...
Generated: 2026-05-22T08:37:58.985Z
...
- fresh: owner-loop - data/autonomous-owner-loop.json is 0.14h old.
- fresh: operator - data/autonomous-operator.json is 0.14h old.
- fresh: autonomous-self-update - data/autonomous-self-update.json is 1.38h old.
- fresh: production-readiness - data/production-readiness.json is 0.14h old.
- fresh: deployment-plan - data/deployment-plan.json is 0.14h old.
- fresh: repository-readiness - data/repository-readiness.json is 0.14h old.
- fresh: repository-bootstrap - data/repository-bootstrap.json is 0.14h old.
- fresh: production-bootstrap - data/production-bootstrap.json is 0.14h old.
- fresh: production-activation - data/production-activation.json is 0.14h old.
- fresh: production-environment - data/production-environment.json is 6.53h old.
- fresh: event-collector-deployment - data/event-collector-deployment.json is 2.92h old.
- fresh: event-collector-smoke - data/event-collector-smoke.json is 1.8h old.
- fresh: local-event-bridge - data/local-event-bridge.json is 1.8h old.
- fresh: event-ingest - data/event-ingest.json is 1.8h old.
- fresh: event-ingest-smoke - data/event-ingest-smoke.json is 1.8h old.
- fresh: analytics-rollup - data/analytics-rollup.json is 1.8h old.
- fresh: experiment-results - data/experiment-results.json is 3.83h old.
- fresh: growth-plan - data/growth-plan.json is 1.92h old.
- fresh: portfolio-policy - data/portfolio-policy.json is 1.92h old.
- fresh: traffic-seeding - data/traffic-seeding.json is 1.92h old.
- fresh: acquisition-learning - data/acquisition-learning.json is 1.79h old.
- fresh: organic-seed-loop - data/organic-seed-loop.json is 1.79h old.
- fresh: retention-loop - data/retention-loop.json is 1.79h old.
- fresh: release-candidate - data/release-candidate.json is 0.14h old.
- fresh: post-deploy-smoke - data/post-deploy-smoke.json is 0.14h old.
- fresh: post-deploy-artifact-sync - data/post-deploy-artifact-sync.json is 0.14h old.
- fresh: live-site-monitor - data/live-site-monitor.json is 0.14h old.
- fresh: release-health - data/release-health.json is 6.53h old.
- fresh: product-optimization - data/product-optimization.json is 1.92h old.
- fresh: product-gate-recovery - data/product-gate-recovery.json is 1.79h old.
- fresh: product-gate-sample-plan - data/product-gate-sample-plan.json is 1.79h old.
- fresh: completion-loop - data/completion-loop.json is 1.91h old.
- fresh: replay-loop - data/replay-loop.json is 1.91h old.
- fresh: first-move-coach - data/first-move-coach.json is 1.91h old.
- fresh: pwa-install-loop - data/pwa-install-loop.json is 1.79h old.
- fresh: applied-improvements - data/applied-improvements.json is 3.83h old.
- fresh: improvement-backlog - data/improvement-backlog-summary.json is 1.92h old.
- fresh: improvement-routing - data/improvement-routing.json is 1.92h old.
- fresh: objective-audit - data/objective-audit.json is 0.14h old.
...
- pass: github-self-update-workflow - Gated GitHub workflow can persist allowlisted verified generated changes after post-deploy evidence sync with production env and workflow token evidence when explicitly enabled.
...
- pass: production-input-watch-workflow - Production input watch refreshes deploy/readiness evidence after owner-provided repository variables or secrets, gates direct commits, and avoids workflow dispatch or raw event storage.
- pass: public-evidence-intake-workflow - Public evidence intake ingests read-only GitHub Issues, refreshes safe aggregate handoff evidence, gates direct commits, and avoids raw events or issue mutation.
