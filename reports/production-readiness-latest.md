...
Generated: 2026-05-25T18:00:05.837Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 685.4 KB / 185.3 KB gzip; deferred game chunk GameCanvas-DFETsvNR.js.
...
- blocker: live-site-monitor - Live monitor is live-site-monitor-planned; origin https://moshequ.github.io/autonomous-game-lab; checks 20/32 passed; live matches synced deploy true.
...
Deferred game chunk: GameCanvas-DFETsvNR.js
...
- pass: performance-game-runtime-deferred - GameCanvas-DFETsvNR.js is deferred from the initial shell.
...
Candidate: pwa-5489b61147d7
Files: 72
Aggregate SHA-256: 5489b61147d731d407536149e19539d273a077860420a620457f22a894d0cd78
...
Workflow run: 26412940808
Artifact candidate: pwa-74463d104cca
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26412940808.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26412940808.
...
Origin: https://moshequ.github.io/autonomous-game-lab
Checks: 20/32 passed (0 failed)
Live candidate: pwa-74463d104cca
Live matches synced deploy: true
- pass: live-monitor-app-shell - Live read-only check passed.
- blocked: live-monitor-manifest-webmanifest - fetch failed
- blocked: live-monitor-sw-js - fetch failed
- blocked: live-monitor-privacy-html - fetch failed
- pass: live-monitor-support-html - Live read-only check passed.
- blocked: live-monitor-measurement-status-html - fetch failed
- blocked: live-monitor-measurement-status-json - fetch failed
