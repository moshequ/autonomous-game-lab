...
Generated: 2026-05-23T01:07:58.712Z
...
- ready: repo-bootstrap-commit-current-snapshot - 105 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 679.3 KB / 183.9 KB gzip; deferred game chunk GameCanvas-GevmS6GM.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 55; smoke URLs 24.
- pass: post-deploy-smoke-runner - Post-deploy smoke is post-deploy-smoke-observed-live; origin https://moshequ.github.io/autonomous-game-lab; checks 25/25 passed, 0 blocked; local artifact predeploy-artifact-smoke-passed 25/25 passed.
- pass: live-site-monitor - Live monitor is live-site-monitor-passed; origin https://moshequ.github.io/autonomous-game-lab; checks 25/25 passed; live matches synced deploy true.
...
- pass: production-bootstrap - Production bootstrap is production-bootstrap-ready; mode can-apply-configured-actions; external blockers 14.
...
- pass: autonomous-operator - Autonomous operator is operator-plan-ready; selected collect-gate-sample-local-drops; execution not-requested.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 65; unsafe pending 0; remote push held.
...
Initial JS: 679.3 KB (183.9 KB gzip)
Deferred game chunk: GameCanvas-GevmS6GM.js
- pass: performance-initial-js-budget - Initial JS is 679.3 KB; budget is 680 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 183.9 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-GevmS6GM.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-GevmS6GM.js at 1361.4 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.4 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-0f67ffaa4bb0
Files: 55
Aggregate SHA-256: 0f67ffaa4bb085c1835a3778a388ca6fb3451420c9664884b2e7cc11c53c5f7e
- pass: release-dist-inventory - 55 dist files inventoried.
- pass: release-required-files - 29/29 required files present.
...
- pass: release-post-deploy-smoke-plan - 24 post-deploy smoke URL(s) planned.
...
Candidate: pwa-0f67ffaa4bb0
Checks: 25/25 passed (0 blocked)
Local artifact: predeploy-artifact-smoke-passed (25/25 passed)
...
Workflow run: 26319271469
Artifact candidate: pwa-1f8425da75f2
Live candidate: pwa-1f8425da75f2
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26319271469.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26319271469.
- pass: artifact-sync-strict-smoke-artifact - Artifact status post-deploy-smoke-passed; strict manifest comparison true; checks 25/25.
...
- pass: live-monitor-analytics-unlock-html - Live read-only check passed.
...
- pass: cadence-production-input-watch-workflow - Production input watch refreshes production environment, deploy/readiness evidence, unlock follow-ups, and measurement status after owner-provided repository variables or secrets, gates direct commits, and avoids workflow dispatch or raw event storage.
...
- pass: self-update-safe-path-allowlist - 65 safe pending file(s), 0 unsafe pending file(s).
...
- pass: android-root-assetlinks-root-assetlinks-needed - Native package is already root-verifiable or does not need a root handoff.
...
- available: android-root-assetlinks-github-cli - GitHub CLI automation is available for the repository context.
