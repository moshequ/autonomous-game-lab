...
Generated: 2026-05-22T10:14:49.434Z
...
- ready: repo-bootstrap-commit-current-snapshot - 30 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 673 KB / 183.1 KB gzip; deferred game chunk GameCanvas-B7qn5XKG.js.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 106; unsafe pending 0; remote push held.
...
Deferred game chunk: GameCanvas-B7qn5XKG.js
...
- pass: performance-game-runtime-deferred - GameCanvas-B7qn5XKG.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-B7qn5XKG.js at 1361.4 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.4 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-5074ce703612
Files: 50
Aggregate SHA-256: 5074ce70361219c9e27c8e4ac5728beefa8c5538fb5a34250b1c973323bc73fd
...
Workflow run: 26281513216
Artifact candidate: pwa-d58ce6d82875
Live candidate: pwa-d58ce6d82875
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26281513216.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26281513216.
...
- pass: self-update-safe-path-allowlist - 106 safe pending file(s), 0 unsafe pending file(s).
