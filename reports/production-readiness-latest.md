...
Generated: 2026-05-19T09:36:47.253Z
...
- ready: repo-bootstrap-commit-current-snapshot - 38 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 656.5 KB / 174.1 KB gzip; deferred game chunk GameCanvas-C74Khzxg.js.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 54; unsafe pending 0; remote push held.
...
Initial JS: 656.5 KB (174.1 KB gzip)
Deferred game chunk: GameCanvas-C74Khzxg.js
- pass: performance-initial-js-budget - Initial JS is 656.5 KB; budget is 675 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 174.1 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-C74Khzxg.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-C74Khzxg.js at 1360.8 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1360.8 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-a0d2f3d75d9b
Files: 39
Aggregate SHA-256: a0d2f3d75d9bca7824b8241a04290f4f1668cfc4d1f970c92d6e9793433ba66f
...
- pass: self-update-safe-path-allowlist - 54 safe pending file(s), 0 unsafe pending file(s).
