...
Generated: 2026-05-27T20:37:53.587Z
...
- ready: repo-bootstrap-commit-current-snapshot - 98 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 676.8 KB / 178.3 KB gzip; deferred game chunk GameCanvas-jEQvnxsQ.js.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 130; unsafe pending 0; remote push held.
...
Deferred game chunk: GameCanvas-jEQvnxsQ.js
- pass: performance-initial-js-target - Initial JS is 676.8 KB; target is 686 KB.
- pass: performance-initial-js-budget - Initial JS is 676.8 KB; deploy cap is 700 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-jEQvnxsQ.js is deferred from the initial shell.
...
Candidate: pwa-cc0e31b8ecf7
Files: 101
Aggregate SHA-256: cc0e31b8ecf7091292385dfa729db4264f920591a896753e3581a6c95f5d1238
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26524336852.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26524336852.
...
- monitor: artifact-sync-deployment-freshness - Current main 98311f2b9be1 is the post-deploy evidence commit for deployed source 3c235f2d2032.
...
- pass: self-update-safe-path-allowlist - 130 safe pending file(s), 0 unsafe pending file(s).
