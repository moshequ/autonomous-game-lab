...
Generated: 2026-05-22T21:36:03.578Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 673.3 KB / 183.1 KB gzip; deferred game chunk GameCanvas-CQ2nKUQz.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 51; smoke URLs 20.
- pass: post-deploy-smoke-runner - Post-deploy smoke is post-deploy-smoke-observed-live; origin https://moshequ.github.io/autonomous-game-lab; checks 21/21 passed, 0 blocked; local artifact predeploy-artifact-smoke-passed 21/21 passed.
- pass: live-site-monitor - Live monitor is live-site-monitor-passed; origin https://moshequ.github.io/autonomous-game-lab; checks 21/21 passed; live matches synced deploy true.
...
- pass: autonomous-operator - Autonomous operator is operator-plan-ready; selected optimize-daily-retention; execution not-requested.
...
Initial JS: 673.3 KB (183.1 KB gzip)
Deferred game chunk: GameCanvas-CQ2nKUQz.js
- pass: performance-initial-js-budget - Initial JS is 673.3 KB; budget is 680 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 183.1 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-CQ2nKUQz.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-CQ2nKUQz.js at 1361.4 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.4 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-744110945e17
Files: 51
Aggregate SHA-256: 744110945e17e5ac7fb26efba3eebbeafee6ce02f2b3a4402717d63234cfbefd
- pass: release-dist-inventory - 51 dist files inventoried.
- pass: release-required-files - 25/25 required files present.
...
- pass: release-post-deploy-smoke-plan - 20 post-deploy smoke URL(s) planned.
...
Candidate: pwa-744110945e17
Checks: 21/21 passed (0 blocked)
Local artifact: predeploy-artifact-smoke-passed (21/21 passed)
...
Workflow run: 26313080661
Artifact candidate: pwa-7e15024010e0
Live candidate: pwa-7e15024010e0
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26313080661.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26313080661.
- pass: artifact-sync-strict-smoke-artifact - Artifact status post-deploy-smoke-passed; strict manifest comparison true; checks 21/21.
