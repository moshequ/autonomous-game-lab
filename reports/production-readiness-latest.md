...
Generated: 2026-05-26T14:43:17.611Z
...
- ready: repo-bootstrap-commit-current-snapshot - 97 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 660.3 KB / 176.7 KB gzip; deferred game chunk GameCanvas-6dV-t5iy.js.
...
Initial JS: 660.3 KB (176.7 KB gzip)
Deferred game chunk: GameCanvas-6dV-t5iy.js
- pass: performance-initial-js-target - Initial JS is 660.3 KB; target is 686 KB.
- pass: performance-initial-js-budget - Initial JS is 660.3 KB; deploy cap is 700 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 176.7 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-6dV-t5iy.js is deferred from the initial shell.
...
Candidate: pwa-f16bad34c506
Files: 93
Aggregate SHA-256: f16bad34c506486f860fd1928f4dec240ae283110d2e2c664699e29281b5f114
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26454733907.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26454733907.
...
- monitor: artifact-sync-deployment-freshness - Current main b7dab1d1a308 is the post-deploy evidence commit for deployed source 2ac8fdb0ca51.
