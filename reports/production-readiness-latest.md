...
Generated: 2026-05-20T14:40:44.327Z
...
- ready: repo-bootstrap-commit-current-snapshot - 13 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 629.4 KB / 172.7 KB gzip; deferred game chunk GameCanvas-93XgBgl5.js.
...
Deferred game chunk: GameCanvas-93XgBgl5.js
- pass: performance-initial-js-budget - Initial JS is 629.4 KB; budget is 675 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 172.7 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-93XgBgl5.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-93XgBgl5.js at 1360.9 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1360.9 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-1b36417cae58
Files: 44
Aggregate SHA-256: 1b36417cae589d882d59c1a59a25434760415e707f55d9dfde573abbb1d83c3b
...
Workflow run: 26169563431
Artifact candidate: pwa-4cedf81c09ca
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26169563431.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26169563431.
