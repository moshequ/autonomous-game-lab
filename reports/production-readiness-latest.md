...
Generated: 2026-05-27T07:26:15.986Z
...
- ready: repo-bootstrap-commit-current-snapshot - 85 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 675 KB / 178 KB gzip; deferred game chunk GameCanvas-DT6lUWhB.js.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 132; unsafe pending 0; remote push held.
...
Initial JS: 675 KB (178 KB gzip)
Deferred game chunk: GameCanvas-DT6lUWhB.js
- pass: performance-initial-js-target - Initial JS is 675 KB; target is 686 KB.
- pass: performance-initial-js-budget - Initial JS is 675 KB; deploy cap is 700 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 178 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-DT6lUWhB.js is deferred from the initial shell.
...
Candidate: pwa-2d2f12b171ed
Files: 101
Aggregate SHA-256: 2d2f12b171ed0f34f915cf42899f4f3585a98676d024964fa257b306c7ba9ca2
...
- pass: release-post-deploy-smoke-plan - 33 post-deploy smoke URL(s) planned.
...
Workflow run: 26497078521
Artifact candidate: pwa-1468950d6290
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26497078521.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26497078521.
...
- pass: artifact-sync-deployment-freshness - Current main f5191c9f243b is deployed.
...
- pass: live-monitor-owner-unlock-html - Live read-only check passed.
...
- ready: bootstrap-repository-channel - Repository moshequ/autonomous-game-lab; git worktree ready; workflow dispatch ready.
- ready: bootstrap-repository-bootstrap - Repository bootstrap repository-bootstrap-ready; helper ops/github/bootstrap-repository.sh; local git ready.
...
- pass: cadence-production-input-watch-workflow - Production input watch refreshes production environment, zero-secret runtime config, deploy/readiness evidence, owner-unlock queue follow-ups, and measurement status after owner-provided repository variables or public workflow inputs, gates direct commits, and avoids workflow dispatch or raw event storage.
...
- pass: self-update-safe-path-allowlist - 132 safe pending file(s), 0 unsafe pending file(s).
