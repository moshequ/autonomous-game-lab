...
Generated: 2026-05-27T08:45:39.953Z
...
- ready: repo-bootstrap-commit-current-snapshot - 119 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 674.6 KB / 177.8 KB gzip; deferred game chunk GameCanvas-CSBjLGvZ.js.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 122; unsafe pending 0; remote push held.
...
Initial JS: 674.6 KB (177.8 KB gzip)
Deferred game chunk: GameCanvas-CSBjLGvZ.js
- pass: performance-initial-js-target - Initial JS is 674.6 KB; target is 686 KB.
- pass: performance-initial-js-budget - Initial JS is 674.6 KB; deploy cap is 700 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 177.8 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-CSBjLGvZ.js is deferred from the initial shell.
...
Candidate: pwa-6f8d4a38074f
Files: 101
Aggregate SHA-256: 6f8d4a38074f6e61a696decc8793643d1d3200775e6553498b069b3ebb516cf9
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26497710478.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26497710478.
...
- pass: artifact-sync-deployment-freshness - Current main ce660fc8555c is deployed.
...
- pass: self-update-safe-path-allowlist - 122 safe pending file(s), 0 unsafe pending file(s).
