...
Generated: 2026-05-21T05:37:13.188Z
...
- ready: repo-bootstrap-commit-current-snapshot - 44 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 654.9 KB / 178.8 KB gzip; deferred game chunk GameCanvas-M_HQc9dt.js.
...
- pass: autonomous-operator - Autonomous operator is operator-plan-ready; selected check-performance-budget; execution not-requested.
...
Deferred game chunk: GameCanvas-M_HQc9dt.js
...
- pass: performance-game-runtime-deferred - GameCanvas-M_HQc9dt.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-M_HQc9dt.js at 1361.1 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.1 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-7fe93510eed4
Files: 44
Aggregate SHA-256: 7fe93510eed4a4d915f0047a4400ba7ed9ca2b32715579de42b1cb9026bb8a89
...
Workflow run: 26207392166
Artifact candidate: pwa-1e69ad49e606
Live candidate: pwa-1e69ad49e606
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26207392166.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26207392166.
...
Mode: plan-only
Selected action: check-performance-budget
