...
Generated: 2026-05-23T01:45:27.010Z
...
- ready: repo-bootstrap-commit-current-snapshot - 64 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 680.7 KB / 184.8 KB gzip; deferred game chunk GameCanvas-DPd6klEt.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 56; smoke URLs 24.
...
- pass: autonomous-operator - Autonomous operator is operator-plan-ready; selected refresh-first-move-coach; execution not-requested.
...
Initial JS: 680.7 KB (184.8 KB gzip)
Deferred game chunk: GameCanvas-DPd6klEt.js
- pass: performance-initial-js-budget - Initial JS is 680.7 KB; budget is 682 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 184.8 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-DPd6klEt.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-DPd6klEt.js at 1361.7 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.7 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-facaaaf22c70
Files: 56
Aggregate SHA-256: facaaaf22c7078e83101a95c39cd6f72f81305caf2c8365ac52f076b5747fa92
- pass: release-dist-inventory - 56 dist files inventoried.
...
Workflow run: 26320140437
Artifact candidate: pwa-8e93f910b833
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26320140437.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26320140437.
