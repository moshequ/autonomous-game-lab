...
Generated: 2026-05-24T20:26:53.880Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 681.5 KB / 185 KB gzip; deferred game chunk GameCanvas-SghWzhOj.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 70; smoke URLs 29.
- pass: post-deploy-smoke-runner - Post-deploy smoke is post-deploy-smoke-observed-live; origin https://moshequ.github.io/autonomous-game-lab; checks 30/30 passed, 0 blocked; local artifact predeploy-artifact-smoke-passed 30/30 passed.
- pass: live-site-monitor - Live monitor is live-site-monitor-passed; origin https://moshequ.github.io/autonomous-game-lab; checks 30/30 passed; live matches synced deploy true.
...
Initial JS: 681.5 KB (185 KB gzip)
Deferred game chunk: GameCanvas-SghWzhOj.js
- pass: performance-initial-js-budget - Initial JS is 681.5 KB; budget is 686 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-SghWzhOj.js is deferred from the initial shell.
...
- pass: release-dist-inventory - 70 dist files inventoried.
- pass: release-required-files - 34/34 required files present.
...
- pass: release-post-deploy-smoke-plan - 29 post-deploy smoke URL(s) planned.
...
Candidate: pwa-282ce0f31806
Checks: 30/30 passed (0 blocked)
Local artifact: predeploy-artifact-smoke-passed (30/30 passed)
...
Workflow run: 26371866217
Artifact candidate: pwa-90841adbe8ca
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26371866217.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26371866217.
- pass: artifact-sync-strict-smoke-artifact - Artifact status post-deploy-smoke-passed; strict manifest comparison true; checks 30/30.
