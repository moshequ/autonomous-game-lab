...
Generated: 2026-05-26T08:45:44.087Z
...
- ready: repo-bootstrap-commit-current-snapshot - 74 repository evidence file(s) changed during this dry run; the outer verified commit will persist them.
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 655 KB / 175.5 KB gzip; deferred game chunk GameCanvas-C-5KKU9c.js.
...
Initial JS: 655 KB (175.5 KB gzip)
Deferred game chunk: GameCanvas-C-5KKU9c.js
- pass: performance-initial-js-target - Initial JS is 655 KB; target is 686 KB.
- pass: performance-initial-js-budget - Initial JS is 655 KB; deploy cap is 700 KB.
- pass: performance-initial-js-gzip-budget - Initial JS gzip is 175.5 KB; budget is 200 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-C-5KKU9c.js is deferred from the initial shell.
...
Workflow run: 26441978141
Artifact candidate: pwa-fbac265129d5
...
- pass: artifact-sync-successful-pages-run - Latest successful web-pwa-deploy.yml run is 26441978141.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26441978141.
