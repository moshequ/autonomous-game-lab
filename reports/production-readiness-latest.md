...
Generated: 2026-05-22T05:18:51.338Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 671.9 KB / 182.7 KB gzip; deferred game chunk GameCanvas-C8Z_i2RB.js.
...
Initial JS: 671.9 KB (182.7 KB gzip)
Deferred game chunk: GameCanvas-C8Z_i2RB.js
- pass: performance-initial-js-budget - Initial JS is 671.9 KB; budget is 676 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-C8Z_i2RB.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-C8Z_i2RB.js at 1361.4 KB.
- pass: performance-deferred-game-budget - Deferred game chunk is 1361.4 KB; monitor budget is 1600 KB.

## Release Candidate

Status: release-candidate-ready
Candidate: pwa-6319adfbcec5
Files: 49
Aggregate SHA-256: 6319adfbcec5efdeb14468e858fedfdff2636c13dfd9a67c857f69615599c89c
...
Workflow run: 26269845545
Artifact candidate: pwa-3bc546ec7ae1
Live candidate: pwa-3bc546ec7ae1
...
- pass: artifact-sync-explicit-pages-run - Explicit web-pwa-deploy.yml run is 26269845545.
- pass: artifact-sync-post-deploy-smoke-artifact - Downloaded post-deploy-smoke artifact from run 26269845545.
...
- pass: cadence-post-self-update-deploy - Pages deployment builds the committed PWA artifact from gated self-update and public-evidence workflows, so persisted generated improvements can publish without manual dispatch.
