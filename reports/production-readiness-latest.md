...
Generated: 2026-05-20T02:20:50.385Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 664.4 KB / 175.9 KB gzip; deferred game chunk GameCanvas-BUDhJaf2.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 41; smoke URLs 12.
- pass: post-deploy-smoke-runner - Post-deploy smoke is blocked-missing-origin; origin missing; checks 0/13 passed, 13 blocked; local artifact predeploy-artifact-smoke-passed 13/13 passed.
...
Deferred game chunk: GameCanvas-BUDhJaf2.js
- pass: performance-initial-js-budget - Initial JS is 664.4 KB; budget is 675 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-BUDhJaf2.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-BUDhJaf2.js at 1360.8 KB.
...
- pass: release-dist-inventory - 41 dist files inventoried.
- pass: release-required-files - 16/16 required files present.
...
- pass: release-post-deploy-smoke-plan - 12 post-deploy smoke URL(s) planned.
...
Origin: missing
Candidate: pwa-8010349b10c6
Checks: 0/13 passed (13 blocked)
Local artifact: predeploy-artifact-smoke-passed (13/13 passed)
