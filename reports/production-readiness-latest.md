...
Generated: 2026-05-23T03:47:21.246Z
...
- pass: performance-budget - Performance budget is performance-budget-ready; initial JS 685.3 KB / 185.3 KB gzip; deferred game chunk GameCanvas-CtU_Jaby.js.
- pass: release-candidate - Release candidate is release-candidate-ready; files 58; smoke URLs 25.
- pass: post-deploy-smoke-runner - Post-deploy smoke is post-deploy-smoke-observed-live; origin https://moshequ.github.io/autonomous-game-lab; checks 25/25 passed, 0 blocked; local artifact predeploy-artifact-smoke-passed 26/26 passed.
...
- pass: autonomous-self-update - Autonomous self-update is self-update-ready; safe pending 25; unsafe pending 0; remote push held.
...
Initial JS: 685.3 KB (185.3 KB gzip)
Deferred game chunk: GameCanvas-CtU_Jaby.js
- pass: performance-initial-js-budget - Initial JS is 685.3 KB; budget is 686 KB.
...
- pass: performance-game-runtime-deferred - GameCanvas-CtU_Jaby.js is deferred from the initial shell.
- pass: performance-largest-js-deferred - Largest JS chunk is GameCanvas-CtU_Jaby.js at 1361.7 KB.
...
- pass: release-post-deploy-smoke-plan - 25 post-deploy smoke URL(s) planned.
...
- pass: self-update-safe-path-allowlist - 25 safe pending file(s), 0 unsafe pending file(s).
