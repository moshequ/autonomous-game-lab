...
Generated: 2026-05-25T17:13:27.238Z
...
- pass: product-gate-recovery-json - dist/product-gate-recovery.json - Local production artifact matched required text.
...
- pass: store-readiness-html - dist/store-readiness.html - Local production artifact matched required text.
- pass: store-readiness-json - dist/store-readiness.json - Local production artifact matched required text.
...
- pass: monetization-html - dist/monetization.html - Local production artifact matched required text.
...
- Live Pages is reachable and serving pwa-5a891812ae19; run the deploy workflow for strict proof of the current local candidate if needed.
