...
Generated: 2026-05-26T20:06:54.917Z
...
- repository-preflight: gh auth status && npm run autonomous:repo-readiness
- repository-bootstrap-plan: ./ops/github/bootstrap-repository.sh --print && npm run autonomous:repo-bootstrap
